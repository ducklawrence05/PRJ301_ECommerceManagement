...
<html>
    <head>
        <meta charset="UTF-8" />
        <title><fmt:message key="create.category.title" /></title>
    ...
    <body>
        ...
        <div class="container mt-5 bg-light p-4 shadow-sm" style="min-height: 80vh">
            <h3 class="mb-3"><fmt:message key="create.new.category" /></h3>
            ...
            <form action="${pageContext.request.contextPath}/main/category/create" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="description" name="description"
                              class="form-control" rows="4" placeholder="<fmt:message key="enter.description" />"
