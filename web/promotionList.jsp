...
<div class="container mt-4">
    ...
    <form action="${pageContext.request.contextPath}/promotion" method="GET" class="row g-2 mb-3">
        ...
        <div class="col-md-auto">
            ...
            <a href="${pageContext.request.contextPath}/promotion" class="btn btn-secondary">Clear</a>
        </div>
    </form>
    ...
    <form action="${pageContext.request.contextPath}/promotion" method="GET" class="mb-3">
        <button type="submit" name="action" value="create" class="btn btn-success">Create new promotion</button>
    </form>
        ...
        <c:when test="${not empty requestScope.promotions}">
            <c:forEach var="promotion" items="${requestScope.promotions}" varStatus="status">
                <div class="mb-4 p-3 border border-primary rounded">
                    ...
                    <h4 class="mb-2">
                        <form action="${pageContext.request.contextPath}/promotion" method="GET" style="display:inline;">
                    ...
                    <div class="mb-2">
                        ...
                        <form action="${pageContext.request.contextPath}/promotion" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure to delete this promotion?');">
